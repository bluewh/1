...
<div class="page-container">
    <form class="form-horizontal" id="form-article-add" action="/picture/addAction">
        <div class="row cl">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="0" placeholder="" id="pOrdervalue" name="pOrdervalue">
            </div>
        </div>
        <!--<div class="row cl">-->
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="0" placeholder="" id="pAuthor" name="pAuthor">
            </div>
        </div>
        <!--<div class="row cl">-->
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <textarea name="pTags" cols="" rows="" class="textarea"  placeholder="说点什么...最少输入10个字符" datatype="*10-100" dragonfly="true" nullmsg="备注不能为空！"></textarea>
