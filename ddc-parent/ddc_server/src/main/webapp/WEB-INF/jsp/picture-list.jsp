...
<%--{field: 'pName', title: '图片标题', width: '10%'}--%>
<%--, {field: 'pClassify', title: '栏目', width: '10%'}--%>
<%--, {field: 'picture', title: '封面', width: '10%'}--%>

<%--, {field: 'pAuthor', title: 'pAuthor', width: '30%'}--%>
    ...
    <form class="layui-form" action="">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" name="pName" value="{{ d.pName || '' }}" lay-verify="required"
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" name="picture" value="{{ d.picture || '' }}"  placeholder="请输入封面地址"
                       autocomplete="off" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">pClassify</label>
            <div class="layui-input-inline">
                <input type="text" name="pClassify" value="{{ d.pClassify || '' }}"  placeholder="栏目id"
                       autocomplete="off" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" name="pAuthor" value="{{ d.pAuthor || '' }}"  placeholder="作者"
                       autocomplete="off" class="layui-input">
            </div>
        </div>
        ...
        layui.use(['table', 'laytpl', 'element', 'form'], function () {
            ...
            table.render({
                ...
                , cols: [[ //表头
                    ...
                    , {field: 'pAuthor', title: '作者', width: '30%'}
