...
<script id="demo" type="text/html">
    <form class="layui-form" action="">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" name="mobile" value="{{ d.mobile || '' }}" lay-verify="mobile" placeholder="请输入号码"
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" name="city" value="{{ d.city || '' }}" lay-verify="city" placeholder="请输入城市
                       autocomplete="off" class="layui-input">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" name="path" value="{{ d.path || '' }}" lay-verify="pathz" placeholder="请输入附件"
                       autocomplete="off" class="layui-input">
            </div>
        </div>
        ...
        layui.use(['table', 'laytpl', 'element', 'form'], function () {
            ...
            table.render({
                ...
                , cols: [[ //表头
                    ...
                    , {field: 'createT', title: '加入时间', width: '20%'}
                    , {
